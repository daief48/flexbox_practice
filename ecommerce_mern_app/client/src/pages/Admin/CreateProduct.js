    ...
    <div className="row">
      ...
      <div className="col-md-9">
        ...
        <div className="m-1 w-75">
          ...
          <div className="mb-3">
            <textarea type="text" value={description} placeholder='Write a name' className='form-control' onChange={(e) => setDescription(e.target.value)} />
          </div>
          <div className="mb-3">
            <input type="number" value={price} placeholder='Write a Price' className='form-control' onChange={(e) => setPrice(e.target.value)} />
          </div>
          <div className="mb-3">
            <input type="number" value={quantity} placeholder='Write a Price' className='form-control' onChange={(e) => setQuantity(e.target.value)} />
          </div>
          <div className="mb-3">
